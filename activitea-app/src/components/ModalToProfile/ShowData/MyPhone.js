        ...
        <table className='profileTable'>
            <tbody>
                {phoneTable.map((phone)=>(
                    <tr key={phone.id}>
                        <td>{phone.phone}</td>
                        <td><img onClick={handleUpdate} id={phone.id} className='profileIcons' src={editIcon}/></td>
                        <td><img onClick={handleDelete} id={phone.id} className='profileIcons' src={deleteIcon}/></td>
                    </tr>
                ))}
            </tbody>
        </table>
